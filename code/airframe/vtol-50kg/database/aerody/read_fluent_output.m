function meta = read_fluent_output(list)
...
for i = 1 : length(list)
    ...
    meta(end+1).file = file;
    meta(end).name = list(i).name;
    ...
    meta(end).data{1} = array2table(data, 'VariableNames', headers, 'RowNames', rownames);
    ...
    meta(end).data{2} = array2table(data, 'VariableNames', headers, 'RowNames', rownames);
