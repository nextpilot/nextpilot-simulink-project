...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% - Generated on:   02-Nov-2025 15:06:55
...
switch action
  ...
  case 'CSCDefn'
    ...
    set(h, 'HeaderFile', 'global_params.h');
    set(h, 'IsHeaderFileInstanceSpecific', false);
    set(h, 'DefinitionFile', 'global_params.c');
    ...
    set(h, 'CSCTypeAttributesClassName', 'Simulink.CSCTypeAttributes_FlatStructure');
        ...
        set(h.CSCTypeAttributes, 'TypeName', 'global_params_t');
        set(h.CSCTypeAttributes, 'TypeToken', '');
        set(h.CSCTypeAttributes, 'TypeTag', 'global_params_s');
