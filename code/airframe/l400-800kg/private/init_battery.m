...
% 额定电压310V
db.battery.nominal_voltage = 310;
% 截止电压是288V
db.battery.cutoff_voltage = 288;
% 总容量12kwh，允许使用的最大电量是9kwh，最后3kwh不用
db.battery.capacity = 12;
% 最大使用电量
db.battery.max_discharge = 9;
% 50A放电曲线多项式
% y = @(x)0.2124*x.^2 + 2.9181*x +281.27;
db.battery.discharge_curve = [0.2124, 2.9181,281.27];

% 设备的大概功耗大概2-3kw
db.battery.other_power = 2.5e3;
