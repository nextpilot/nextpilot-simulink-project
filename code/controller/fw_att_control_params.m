...
* @group FW Attitude Control
%}
PARAM_DEFINE_FLOAT('FW_WR_IMAX', 1.0);
...
* @group FW Attitude Control
%}
PARAM_DEFINE_FLOAT('FW_MAN_P_MAX', 45.0);
...
* @group FW Attitude Control
%}
PARAM_DEFINE_FLOAT('FW_FLAPS_SCL', 1.0);
...
* @group FW Attitude Control
%}
PARAM_DEFINE_FLOAT('FW_FLAPERON_SCL', 0.0);
...
* @increment 0.01
%}
PARAM_DEFINE_FLOAT('FW_DTRIM_R_FLPS', 0.0);
...
* @increment 0.01
%}
PARAM_DEFINE_FLOAT('FW_DTRIM_P_FLPS', 0.0);
