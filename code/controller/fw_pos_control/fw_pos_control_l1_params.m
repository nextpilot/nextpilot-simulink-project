...
%}
PARAM_DEFINE_FLOAT('FW_L1_PERIOD', 20.0);
...
* @group FW L1 Control
%}
PARAM_DEFINE_FLOAT('FW_L1_DAMPING', 0.75);
...
* @group FW L1 Control
%}
PARAM_DEFINE_FLOAT('FW_L1_R_SLEW_MAX', 90.0);
...
* @group FW L1 Control
%}
PARAM_DEFINE_FLOAT('FW_THR_CRUISE', 0.6);
...
* @group FW L1 Control
%}
PARAM_DEFINE_FLOAT('FW_THR_ALT_SCL', 0.0);
...
* @group FW L1 Control
%}
PARAM_DEFINE_FLOAT('FW_P_LIM_MIN', -45.0);
...
* @group FW L1 Control
%}
PARAM_DEFINE_FLOAT('FW_P_LIM_MAX', 45.0);
...
* @group FW L1 Control
%}
PARAM_DEFINE_FLOAT('FW_THR_IDLE', 0.15);
...
* @group FW L1 Control
%}
PARAM_DEFINE_FLOAT('FW_THR_LND_MAX', 1.0);
...
* @group FW L1 Control
%}
PARAM_DEFINE_FLOAT('FW_CLMBOUT_DIFF', 10.0);
...
* @group FW L1 Control
%}
PARAM_DEFINE_FLOAT('FW_LND_HVIRT', 10.0);
...
* @group FW L1 Control
%}
PARAM_DEFINE_FLOAT('FW_LND_FLALT', 3.0);
...
* @group FW L1 Control
%}
PARAM_DEFINE_FLOAT('FW_LND_TLALT', -1.0);
...
* @group FW L1 Control
%}
PARAM_DEFINE_FLOAT('FW_LND_HHDIST', 15.0);
...
* @group FW L1 Control
%}
PARAM_DEFINE_FLOAT('FW_LND_AIRSPD_SC', 1.3);
...
* @group FW TECS
%}
PARAM_DEFINE_FLOAT('FW_T_THR_DAMP', 0.1);
...
* @group FW TECS
%}
PARAM_DEFINE_FLOAT('FW_T_I_GAIN_THR', 0.3);
...
* @group FW TECS
%}
PARAM_DEFINE_FLOAT('FW_T_SPD_OMEGA', 2.0);
...
* @group FW TECS
%}
PARAM_DEFINE_FLOAT('FW_T_TAS_R_TC', 0.2);
