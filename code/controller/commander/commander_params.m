...
* @increment 0.01
%}
PARAM_DEFINE_FLOAT('COM_EF_THROT', 0.5);
...
* @increment 1
%}
PARAM_DEFINE_FLOAT('COM_EF_C2T', 5.0);
...
* @increment 1
%}
PARAM_DEFINE_FLOAT('COM_EF_TIME', 10.0);
...
* @decimal 3
%}
PARAM_DEFINE_FLOAT('COM_RCL_ACT_T', 15.0);
...
* @increment 0.5
%}
PARAM_DEFINE_FLOAT('COM_HOME_H_T', 5.0);
...
* @increment 0.5
%}
PARAM_DEFINE_FLOAT('COM_HOME_V_T', 10.0);
...
* @increment 0.05
%}
PARAM_DEFINE_FLOAT('COM_ARM_EKF_POS', 0.5);
...
* @increment 0.05
%}
PARAM_DEFINE_FLOAT('COM_ARM_EKF_VEL', 0.5);
...
* @increment 0.05
%}
PARAM_DEFINE_FLOAT('COM_ARM_EKF_HGT', 1.0);
...
* @increment 0.05
%}
PARAM_DEFINE_FLOAT('COM_ARM_EKF_YAW', 0.5);
...
* @increment 0.1
%}
PARAM_DEFINE_FLOAT('COM_KILL_DISARM', 5.0);
...
* @increment 1
%}
PARAM_DEFINE_FLOAT('COM_CPU_MAX', 90.0);
