%% 搜索模型 - vtol50kg_linearization 的指定工作点


%% 指定模型名称
model = 'vtol50kg_linearization';
...
% 状态(1) - vtol50kg_linearization/Model|vtol50kg_airfrae/6DOF (Quaternion)/Calculate DCM & Euler Angles/q0 q1 q2 q3
% - 默认模型初始条件用于初始化优化。
